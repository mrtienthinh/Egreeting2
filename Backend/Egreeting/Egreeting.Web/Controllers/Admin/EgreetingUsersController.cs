...
namespace Egreeting.Web.Controllers.Admin
{
    ...
    public class EgreetingUsersController : BaseAdminController
    {
        ...
        {
            return View(ViewNamesConstant.AdminEgreetingUsersIndex, EgreetingUserBusiness.All.ToList());
        }
        ...
        public ActionResult Delete(int? id)
        {
            ...
            return View(ViewNamesConstant.AdminEgreetingUsersDelete,egreetingUser);
        }
